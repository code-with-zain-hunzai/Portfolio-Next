      ...
      <div className="container mx-auto h-full">
        <div className="flex flex-col xl:flex-row items-center justify-center xl:pt-8 xl:pb-24">
          ...
          <div className='text-center xl:text-left order-2 xl:order-none'>
            ...
            <h1 className='h1 mb-6 mt-5'>Hello I'm <span className='text-accent-DEAFULT'>Zain</span>
            </h1>
            <p className='max-w-[500px] mx-auto xl:mx-0 text-white/80'>I excel at crafting elegant digital experiences and am proficient in various programming languages and technologies.</p>
